...
namespace Exxis.Addon.RegistroCompCCRR.CrossCutting.Code.DisposableBO
{
    public class SafeRecordSet : IDisposable
    {
        public class NotRecordFound : Exception
        {
            ...
            /// <param name="query">Query to uses the <see cref="T:Exxis.Addon.RegistroCompCCRR.CrossCutting.Code.DisposableBO.SafeRecordSet"/></param>
