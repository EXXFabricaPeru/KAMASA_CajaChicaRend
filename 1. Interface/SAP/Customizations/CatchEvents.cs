...
using Exxis.Addon.RegistroCompCCRR.Interface.Views.FormattedSearches;
//using Exxis.Addon.RegistroCompCCRR.Interface.Views.Modal;
//using Exxis.Addon.RegistroCompCCRR.Interface.Views.Modal.LiquidationTransporter;
...
namespace Exxis.Addon.RegistroCompCCRR.Interface.Customizations
{
    public static class CatchEvents
    {
        public static void OnClickMenu(MenuEvent menuEvent, out bool handle)
        {
            ...
            //    }
            //}
            if (menuEvent.MenuUID == ApplicationInterfaceHelper.ADD_RECORD_MENU_ID && ApplicationInterfaceHelper.FormIsActive(RegistroComprobante.SAP_FORM_TYPE))
            {
