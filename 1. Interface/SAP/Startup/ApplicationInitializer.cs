...
namespace Exxis.Addon.RegistroCompCCRR.Interface.Startup
{
    public abstract partial class ApplicationInitializer
    {
        ...
        private const string SAP_MODULE_MENU_ID = "43520";//43521
        ...
        private bool try_make_base_menu()
        {
            try
            {
                ...
                _rootSAPMenu = append_sap_menu(_application.Menus.Item(SAP_MODULE_MENU_ID).SubMenus, Constants.Menu.MAIN_APPLICATION, @"EXXIS-Addon Registro Comp. CC y Rend", BoMenuType.mt_POPUP);
                return true;
            }
            catch
            {
